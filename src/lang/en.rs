...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("monitoring_policy_notice_intro", "This corporate RustDesk build is monitored for security and audit purposes."),
        ("monitoring_policy_notice_scope", "Session metadata (for example: user, session status, timestamps, and connection direction) may be collected and sent to the company monitoring server."),
        ("monitoring_policy_notice_ack", "By selecting OK, you confirm you have read this notice."),
        ("Monitoring profile", "Monitoring profile"),
        ("Display Name", "Display Name"),
        ("Avatar URL", "Avatar URL"),
        ("Select image file", "Select image file"),
        ("Select avatar image", "Select avatar image"),
        ("monitoring_profile_avatar_tip", "Use an HTTPS URL or select a local JPG/PNG/WEBP image file for your monitoring avatar."),
