...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Changelog", ""),
        ("Monitoring Policy", "Politica de monitoreo"),
        ("monitoring_policy_notice_intro", "Esta version corporativa de RustDesk se monitorea con fines de seguridad y auditoria."),
        ("monitoring_policy_notice_scope", "Los metadatos de sesion (por ejemplo: usuario, estado de sesion, marcas de tiempo y direccion de conexion) pueden recopilarse y enviarse al servidor de monitoreo de la empresa."),
        ("monitoring_policy_notice_ack", "Al seleccionar OK, confirmas que leiste este aviso."),
        ("Monitoring profile", "Perfil de monitoreo"),
        ("Display Name", "Nombre visible"),
        ("Avatar URL", "URL de avatar"),
        ("Select image file", "Seleccionar archivo de imagen"),
        ("Select avatar image", "Seleccionar avatar"),
        ("monitoring_profile_avatar_tip", "Usa una URL HTTPS o selecciona un archivo local JPG/PNG/WEBP para tu avatar de monitoreo."),
